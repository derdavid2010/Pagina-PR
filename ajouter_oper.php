...
<?php
	...
	if (isset($_POST[agregar])) {
		...
		$query = "INSERT INTO operation (intitule, operation, periode) VALUES ('$intitule', '$operation', '$periode')";
...
<html>
	...
	<body>
		...
		<ul>
			...
			<li><a href="#"  class="active"><i class="material-icons">add</i>&nbsp;Ajouter opération de maintenance</a></li>
		...
		<form id="ajouter_oper" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
				...
				<p>
					<input type="reset" value="Effacer" id="boton">
			  		<input type="submit" name="agregar" value="Ajouter opération" id="boton">
			  	</p>
		</form>
