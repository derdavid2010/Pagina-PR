...
-- Tiempo de generación: 05-02-2019 a las 07:04:13
...
CREATE TABLE `clients` (
  ...
  `tel_responsable` bigint(20) UNSIGNED DEFAULT NULL,
  `tel_mobile` bigint(20) UNSIGNED DEFAULT NULL,
...
--
-- Estructura de tabla para la tabla `machine_p`
--

CREATE TABLE `machine_p` (
  `id_machine` int(11) NOT NULL,
  `id_client` int(11) NOT NULL,
  `nom_machine` varchar(50) NOT NULL,
  `designation` varchar(150) DEFAULT NULL,
...
--
-- Volcado de datos para la tabla `machine_p`
--

INSERT INTO `machine_p` (`id_machine`, `id_client`, `nom_machine`, `designation`, `type`, `reference`, `marque`, `fournisseur`, `commentaire`, `compteur`, `nb_arrets`, `temps_arrets`, `montant_pieces`, `tps_mo`, `nb_inter`) VALUES
(3, 3, 'D-Kit 3', 'Kit de radiocomunicacion 3 ex N5-modele 2010', 'ARF 37', NULL, 'Adeunis-RF', 'Christian Lehingue MSPT', 'modelo 2010', 1, 2, 8, 4, 4, 2),
(4, 3, 'D-Kit 4', 'Kit de radiocomunicacion 4 ex N6-modele 2010\r\n', 'ARF 37', NULL, 'Adeunis-RF', 'Christian Lehingue MSPT', 'modelo 2010\r\n', NULL, NULL, 0, 0, 1, 1),
(7, 3, 'D-Kit 7', 'Kit de radiocomunicacion 7 ex N7-modele 2010\r\n', 'ARF 37 Wireless', 'ARF7531AB\r\n', 'Adeunis-RF', 'Christian Lehingue MSPT', 'modelo 2010\r\n', NULL, 1, 7, 1, 2, 1),
(9, 3, 'D-Kit 9', 'Kit de radiocomunicacion 9 ex N8-modele 2009\r\n', 'ARF 37', NULL, 'Adeunis-RF', 'Christian Lehingue MSPT', 'modelo 2009-equipo reformado el 15-2-2017\r\n', 1, 1, 5, 1, 6, 3),
...
(173, 2, 'D-kit S41', 'Kit de diademas SQUADRA-marzo 2018\r\n', 'SQUADRA modelo US', 'ARF7822AA\r\n', 'Adeunis-RF', 'Christian jean roger LEHINGUE', 'Mise en service : 28 marzo 2018      S/N:\r\n', NULL, NULL, NULL, NULL, NULL, NULL),
(174, 4, 'B-N9-2', 'Banderin ervocom\r\n', '2056.02.0109', NULL, NULL, 'ERVOCOM', '2013\r\n', 1, NULL, 0, 0, 0, 1),
(175, 3, 'asd', 'asd', 'asd', 'asd', '$_REQUEST[\"marque\"]', 'asd', 'asd', 1, 1, 1, 1, 1, 1),
(176, 1, 'bien y tu', 'que tal', 'como estas', '', 'tambien', 'todo genial', '', 1, 1, 1, 1, 1, 1),
(177, 1, 'bien y tu', 'que tal', 'como estas', '', 'tambien', 'todo genial', '', 1, 1, 1, 1, 1, 1),
(178, 1, 'bien y tu', 'que tal', 'como estas', '', 'tambien', 'todo genial', '', 1, 1, 1, 1, 1, 1),
(179, 1, 'bien y tu', 'que tal', 'como estas', '', 'tambien', 'todo genial', '', 1, 1, 1, 1, 1, 1),
(180, 1, 'bien y tu', 'que tal', 'como estas', '', 'tambien', 'todo genial', '', 1, 1, 1, 1, 1, 1),
(181, 1, 'bien y tu', 'que tal', 'como estas', '', 'tambien', 'todo genial', '', 1, 1, 1, 1, 1, 1),
(182, 1, 'bien y tu', 'que tal', 'como estas', '', 'tambien', 'todo genial', '', 1, 1, 1, 1, 1, 1),
(183, 1, 'bien y tu', 'que tal', 'como estas', '', 'tambien', 'todo genial', '', 1, 1, 1, 1, 1, 1),
(184, 3, 'asd', 'asd', 'asd', 'asd', 'asd', 'asd', 'asd', 2, 2, 2, 2, 2, 2),
(185, 6, 'Esta', 'es', 'una', 'prueba', 'de', 'fuego', 'debe salir bien', 1, 2, 3, 4, 5, 6),
(186, 6, 'Esta', 'es', 'una', 'prueba', 'de', 'fuego', 'debe salir bien', 1, 2, 3, 4, 5, 6),
(187, 5, 'probablemente', 'esta', 'sea', 'la', 'ultima', 'prueba', 'y dormire', 6, 5, 4, 3, 2, 1),
(188, 2, 'ahorah', 'asd', 'probaremos nullh', 'asd', 'asd', 'asd', 'asd', 1, 2, 3, 4, 5, 6),
(189, 1, 'ahora', '', ' qwe', 'asd', 'asd', 'asd', 'asd', 1, 2, 3, 4, 5, 6),
(190, 6, 'null ya', '', '', 'qwe', 'qwe', 'qwe', 'qwe', 1, 2, 3, 4, 5, 6),
(191, 6, 'null ya', '', '', '', 'qwe', 'qwe', 'qwe', 1, 2, 3, 4, 5, 6),
(192, 6, 'null ya', '', '', '', '', 'qwe', 'qwe', 1, 2, 3, 4, 5, 6),
(193, 6, 'null ya', '', '', '', '', '', 'qwe', 1, 2, 3, 4, 5, 6),
(194, 6, 'null ya', '', '', '', '', '', '', 1, 2, 3, 4, 5, 6),
(195, 3, 'asd', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(196, 1, 'esta', 'es', 'otra', 'prueba', 'ya', 'quier', 'dormir', 1, 2, 3, 4, 5, 6),
(197, 1, 'ahora', 'NULL', 'probaremos null', 'asd', 'tambien', 'todo genial', 'wqe', 6, 5, 4, 3, 2, 1),
(198, 6, 'otra', '', 'vez', 'alv', 'todos', 'ahhh', 'ahhhhh', 1, 2, 3, 4, 5, 6),
(199, 2, 'asd', '', 'asd', 'asd', 'asd', 'asd', 'asd', 6, 5, 4, 3, 2, 1),
(200, 6, 'asd', '', '', '', '', '', '', NULL, 1, 2, 3, 4, 5),
(201, 1, 'ahora', '', '', '', '', '', '', NULL, NULL, NULL, NULL, NULL, NULL),
(202, 6, 'ahora', 'NULL', '', '', '', '', '', NULL, NULL, NULL, NULL, NULL, NULL),
(203, 1, 'ahora', '', '', '', '', '', '', NULL, NULL, NULL, NULL, NULL, NULL),
(204, 1, 'null ya', 'NULL', '', '', '', '', '', NULL, NULL, NULL, NULL, NULL, NULL),
(205, 6, 'null ya', NULL, '', '', '', '', '', NULL, NULL, NULL, NULL, NULL, NULL),
(206, 3, 'null ya', NULL, '', '', '', '', '', 1, NULL, NULL, NULL, NULL, NULL),
(207, 3, 'null ya', NULL, '', '', '', '', '', 2, NULL, NULL, NULL, NULL, NULL),
(208, 3, 'null ya', NULL, 'NULL', 'NULL', 'NULL', 'NULL', 'NULL', NULL, NULL, NULL, NULL, NULL, NULL),
(209, 3, 'null ya', NULL, NULL, 'NULL', 'NULL', 'NULL', 'NULL', NULL, NULL, NULL, NULL, NULL, NULL),
(210, 4, 'null ya', NULL, NULL, NULL, NULL, NULL, 'NULL', NULL, NULL, NULL, NULL, NULL, NULL),
(211, 4, 'null ya', NULL, 'qwe', 'qwe', 'qwe', 'qwe', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(212, 3, 'null ya', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(213, 3, 'nuevo null', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(214, 1, 'null ya', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(215, 3, 'qwe', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(216, 2, '123', NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL),
(217, 1, '123', NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL),
(218, 2, 'qwe', NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL),
(219, 3, '123', NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL),
(220, 1, '123', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(221, 2, '123', NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, 0),
(222, 6, '123', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(223, 1, 'ahora', NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, 0),
(224, 2, 'null ya', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(225, 2, 'null ya', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(226, 2, 'null ya', NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL),
(227, 2, 'null ya', NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL),
(228, 2, 'null ya', NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, NULL, NULL, NULL),
(229, 2, '123', NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, NULL, NULL),
(230, 1, 'null ya', NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL),
(231, 3, 'null ya', NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, 0),
(232, 3, 'null ya', NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, 0);
...
INSERT INTO `maintenance` (`id_maint`, `id_machine`, `id_oper`, `id_interv`, `date`, `compteur`, `commentaire`) VALUES
(1, 37, 1, 1, '2012-11-09', 0, 'pager desconfigurado-debe tener el codigo naranja para funcionar. cambie 2 pilas de 9V'),
(2, 34, 1, 1, '2013-02-18', 1, NULL),
(3, 26, 1, 1, '2014-01-06', 1, NULL),
(4, 34, 1, 1, '2014-01-14', 0, NULL),
(5, 34, 1, 1, '2014-01-14', 1, NULL),
(6, 37, 1, 1, '2014-02-13', 0, NULL),
(7, 24, 1, 1, '2014-02-21', 1, NULL),
(8, 10, 1, 1, '2014-03-18', 1, NULL),
(9, 16, 1, 1, '2014-03-18', 1, NULL),
(10, 18, 1, 1, '2014-03-18', 1, NULL),
(11, 20, 1, 1, '2014-03-18', 1, NULL),
(12, 24, 1, 1, '2014-03-18', 1, NULL),
(13, 26, 1, 1, '2014-03-18', 1, NULL),
(14, 31, 1, 1, '2014-03-18', 1, 'cambie las 3 pilas preventivamente'),
(15, 36, 1, 1, '2014-03-18', 1, NULL),
(16, 37, 1, 1, '2014-03-18', 1, NULL),
(17, 38, 1, 1, '2014-03-18', 1, NULL),
(18, 39, 1, 1, '2014-03-18', 1, NULL),
(19, 98, 1, 1, '2014-03-18', 1, NULL),
(20, 31, 1, 1, '2014-03-25', 1, 'equipo funcional- ya revisado el 18-3-2014'),
(21, 42, 1, 1, '2014-03-25', 1, 'repuse una rondana de banderin que faltaba'),
(22, 43, 1, 1, '2014-03-25', 1, 'equipo en buenas condiciones de uso'),
(23, 97, 1, 1, '2014-03-25', 1, 'equipo con 1 pila muy descargada y que ya no recibe carga por falta de uso. la reemplace por nueva.'),
(24, 98, 1, 1, '2014-03-25', 1, 'equipo completo pero con pilas muy descargadas. Hay que prever cargarlas antes de usarlo.'),
(25, 26, 1, 1, '2014-08-20', 0, NULL),
(26, 26, 1, 1, '2014-10-13', 1, NULL),
(27, 9, 1, 1, '2015-05-11', 1, 'Equipo funcional. Le falta el botón de 4to. Equipo modelo 2009 en malas condiciones. Prever pronto reemplazo.'),
(28, 10, 1, 1, '2015-05-11', 1, 'Equipo funcional y completo pero ya muy desgatado. Equipo modelo 2010 en malas condiciones. Prever pronto reemplazo.'),
(29, 18, 1, 1, '2015-05-11', 1, 'Equipo completo y funcional. Equipo modelo 2010 en malas condiciones. Prever reemplazo.'),
(30, 19, 1, 1, '2015-05-11', 1, 'Equipo revisado. Le falta el cable de alimentación eléctrica del contacto al cargador.\r\nEquipo ya muy desgastado y con problemas de escucha debido a corrosión de los equipos.\r\nPrever pronto reemplazo.\r\n'),
(31, 21, 1, 1, '2015-05-11', 1, 'Equipo completo y funcional. buene stado'),
(32, 23, 1, 1, '2015-05-11', 1, 'Equipo funcional y completo. buen estado'),
(33, 25, 1, 1, '2015-05-11', 1, 'Equipo revisado. Equipo ya muy desgastado y con problemas de escucha debido a corrosión de los equipos.\r\nPrever pronto reemplazo.\r\n'),
(34, 26, 1, 1, '2015-05-11', 1, 'Equipo revisado. Completo y funcional. Buen estado general.'),
(35, 27, 1, 1, '2015-05-11', 1, 'Equipo. Equipo completo y funcional. Equipo modelo 2010 en condiciones regulares a malas. Prever reemplazo.'),
(36, 28, 1, 1, '2015-05-11', 1, 'Equipo completo y funcional. Equipo modelo 2010 en condiciones regulares. Prever reemplazo.'),
(37, 98, 1, 1, '2015-05-11', 1, 'Equipo revisado. 1 diadema (5ta) con leve perdida de sensibilidad. Equipo Completo y funcional. Muy  estado general de los radios.'),
(38, 62, 1, 1, '2015-05-27', 1, 'Tablero incompleto. Le falta el cargador. Equipo funcional. Equipo bien cuidado - carga bien pero sus pilas ya están a la mitad de vida'),
(39, 66, 1, 1, '2015-05-27', 1, 'Tablero incompleto. Le falta el cargador. Equipo funcional pero su manija esta rota. Equipo muy descuidado con caras rayadas- carga bien pero sus pilas ya están a la mitad de vida'),
(40, 68, 1, 1, '2015-05-27', 1, 'Tablero incompleto. Le falta el cargador. Equipo funcional. carga bien pero sus pilas ya están a la mitad de vida'),
(41, 70, 1, 1, '2015-05-27', 1, 'Tablero incompleto me fue entregado sin estuche de transporte. Equipo funcional. Equipo carga bien pero sus pilas estan al 50% de vida útil.'),
(42, 77, 1, 1, '2015-05-27', 1, 'Tablero completo y funcional- carga al 99%'),
(43, 78, 1, 1, '2015-05-27', 1, 'Tablero completo y funcional-Equipo ya muy viejo y descuidado. carga bien pero sus pilas ya pasaron más de la mitad de vida'),
(44, 81, 1, 1, '2015-05-27', 1, 'Tablero incompleto. Le falta el cargador. Equipo funcional. Equipo con cuidado regular- carga bien pero sus pilas ya están a la mitad de vida'),
(45, 84, 1, 1, '2015-05-27', 1, 'Tablero completo y funcional- carga al 99%'),
(46, 101, 1, 1, '2015-05-27', 1, 'Tablero completo y funcional- carga bien pero sus pilas a la mitad de vida'),
(47, 108, 1, 1, '2015-05-27', 1, 'Tablero con apagado por switch no original agregado. Equipo completo y funcional aunque ya desgastado'),
(48, 109, 1, 1, '2015-05-27', 1, 'Tablero completo y funcional. Equipo ya antiguo y muy descuidado. Su estuche de transporte ya no cierra. Pilas a mitad de vida.'),
(49, 110, 1, 1, '2015-05-27', 1, 'Tablero incompleto. Le falta el cargador. Equipo funcional- carga bien pero sus pilas ya pasaron la mitad de vida'),
(50, 111, 1, 1, '2015-05-27', 1, 'Tablero incompleto. Le falta el cargador. Equipo funcional. carga bien pero sus pilas ya están a la mitad de vida'),
(51, 112, 1, 1, '2015-05-27', 1, 'Tablero completo y funcional, con apariencia nueva. Sus pilas tienen todavía más de la mitad de vida'),
(52, 71, 1, 1, '2015-06-18', 1, 'Tablero con manija rota y muy desgastado. Sus pilas están totalmente agotadas y su chip de control fuera de servicio. Ya no funciona.'),
(53, 75, 1, 1, '2015-06-18', 1, 'Tablero desgastado. Sus pilas están al 50%'),
(54, 76, 1, 1, '2015-06-18', 1, 'Tablero completo y funcional. Equipo con baja iluminación de los números rojos.'),
(55, 113, 1, 1, '2015-06-18', 1, 'Tablero completo y funcional, con apariencia nueva. Sus pilas tienen todavía tienen el tope de vida'),
(56, 114, 1, 1, '2015-06-18', 1, 'Tablero completo y funcional, con apariencia nueva. Sus pilas tienen todavía más de la mitad de vida'),
(57, 115, 1, 1, '2015-06-18', 1, 'Tablero completo y funcional.'),
(58, 64, 1, 1, '2015-07-02', 1, 'TABLERO COMPLETO EN ESTADO REGULAR. Modelo 2011'),
(59, 102, 1, 1, '2015-07-02', 1, 'cambio 1 diadema PHO221 por nueva'),
(60, 104, 1, 1, '2015-07-02', 1, 'equipo en excelente estado'),
(61, 19, 1, 1, '2015-08-24', 1, 'Equipo completo pero ya con bastante uso. Un a diadema con leve pérdida de sensibilidad dejada para el 5to.'),
(62, 70, 1, 1, '2015-08-24', 1, 'Equipo completo.Pilas al 50% de vida útil.'),
(63, 81, 1, 1, '2015-08-24', 0, 'Tablero completo. Pilas con apennas 20% de vida útil. Prever reemplazo.'),
(64, 21, 1, 1, '2015-09-04', 1, 'oxidación de las membranas de los microfonos, pilas desgastadas. Reemplazo de 2 pilas y 2 diademas PHO 020 por nuevas. equipo funcional y completo.'),
(65, 62, 1, 1, '2015-09-17', 1, 'se había pérdido el enchufe redondo del cargador. repuse un conector redondo 3 pines nuevo'),
(66, 28, 1, 1, '2015-09-29', 1, 'prever pronto reemplazo pues el equipo ya esta muy desgastado.'),
(67, 30, 1, 1, '2015-12-16', NULL, NULL),
(68, 79, 1, 1, '2015-12-16', NULL, NULL),
(69, 91, 1, 1, '2015-12-16', NULL, NULL),
(70, 96, 1, 1, '2015-12-16', NULL, NULL),
(71, 121, 1, 1, '2015-12-16', NULL, NULL),
(72, 124, 1, 1, '2015-12-16', NULL, NULL),
(73, 24, 1, 1, '2016-01-07', 1, 'agregue 1 diadema pues solo contaba con 4. Equipo completo y funcional, pero ya se nota su desgaste.'),
(74, 77, 1, 1, '2016-01-07', 1, NULL),
(75, 88, 1, 1, '2016-01-07', 1, 'Tablero funcional y completo. carga al 99%. baterias a 3/4 de vida util'),
(76, 113, 1, 1, '2016-01-07', 1, NULL),
(77, 9, 1, 1, '2016-01-20', 1, 'Equipo ya muy viejo y desgastado\r\nNo usarlo en partidos sino para refacciones\r\nLleva 5 radios, 4 diademas, 0 abrazabrazo, 0 boton 4to, 5 pilas, 1 cargador completo\r\n'),
(78, 20, 1, 1, '2016-01-20', 1, 'equipo funcional revisado'),
(79, 23, 1, 1, '2016-01-20', 1, 'equipo funcional revisado, ya con desgaste visible'),
(80, 24, 1, 1, '2016-01-20', 1, 'Equipo incompleto (le faltan 3 abrazabrazos) y ya con desgaste visible'),
(81, 26, 1, 1, '2016-01-20', 1, 'Equipo incompleto (le falta 1 abrazabrazo) y ya con desgaste visible'),
(82, 29, 1, 1, '2016-01-20', 1, 'equipo funcional pero ya con desgaste visible (2011)'),
(83, 39, 1, 1, '2016-01-20', 1, 'equipo de 2011 ya muy desgastado. el equipo estaba desconfigurado de los swithces que codifican el color de los banderines.'),
(84, 43, 1, 1, '2016-01-20', 1, 'equipo en buen estado y completo'),
(85, 120, 1, 1, '2016-01-20', 1, 'equipo de 2014 en buen estado y funcional'),
(86, 21, 1, 1, '2016-03-15', 1, NULL),
(87, 21, 1, 1, '2016-03-15', 1, 'equipo revisado. equipo ya con uso notable pero funcional'),
(88, 99, 1, 1, '2016-03-15', 1, 'revise todo el equipo. equ pero bien cuidado.equipo funcional y compl,eto . equipo de 2010'),
(89, 26, 1, 1, '2017-02-23', 1, NULL),
(90, 20, 1, 1, '2017-04-11', 1, 'equipo ya desgastado, prever su reemplazo'),
(91, 34, 1, 1, '2017-04-11', 1, NULL),
(92, 99, 1, 1, '2017-04-11', 1, 'equipo en estado muy regular- prever su reemplazo'),
(93, 125, 1, 1, '2017-04-11', 1, 'codigo de color desconfigurado'),
(94, 155, 1, 1, '2017-10-18', NULL, NULL),
(95, 157, 1, 1, '2017-10-18', NULL, NULL),
(96, 29, 1, 1, '2017-11-15', 1, NULL),
(97, 35, 1, 1, '2017-11-15', 1, NULL),
(98, 37, 1, 1, '2017-11-15', 1, NULL),
(99, 37, 1, 1, '2017-11-15', 2, NULL),
(100, 125, 1, 1, '2017-11-15', 1, 'equipo OK'),
(101, 151, 1, 1, '2017-11-15', 1, NULL),
(102, 161, 1, 1, '2017-11-15', NULL, NULL),
(103, 168, 1, 1, '2017-11-15', 1, NULL),
(104, 142, 1, 1, '2017-11-29', 1, 'equipo revisado.Lleva cargador pero le falta su estuche. equipo funcional y en buen estado'),
(105, 82, 1, 1, '2018-01-10', 1, 'equipo de 2011 en buen estado. buena carga de baterías  todavía'),
(106, 168, 1, 1, '2018-09-12', 1, NULL),
(107, 128, 1, 1, '2018-09-19', 1, NULL),
(108, 134, 1, 1, '2018-09-19', 1, NULL),
(109, 139, 1, 1, '2018-09-19', 1, NULL),
(110, 154, 1, 1, '2018-09-19', 1, NULL),
(111, 73, 1, 1, '2018-10-03', NULL, NULL),
(112, 90, 1, 1, '2018-10-03', NULL, NULL),
(113, 94, 1, 1, '2018-10-03', NULL, NULL),
(114, 103, 1, 1, '2018-10-03', NULL, NULL),
(115, 105, 1, 1, '2018-10-03', NULL, NULL),
(116, 106, 1, 1, '2018-10-03', 1, NULL),
(117, 154, 1, 1, '2018-10-03', 1, NULL),
(118, 164, 1, 1, '2018-10-03', 1, NULL),
(119, 165, 1, 1, '2018-10-03', 1, NULL),
(120, 167, 1, 1, '2018-10-03', 1, NULL);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `maintenance_p`
--

CREATE TABLE `maintenance_p` (
  `id_maint` int(11) NOT NULL,
  `id_machine` int(11) NOT NULL,
  `id_oper` int(11) NOT NULL,
  `id_interv` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `maintenance_p`
--

INSERT INTO `maintenance_p` (`id_maint`, `id_machine`, `id_oper`, `id_interv`, `date`, `compteur`, `commentaire`) VALUES
(1, 37, 1, 1, '2012-11-09', 0, 'pager desconfigurado-debe tener el codigo naranja para funcionar. cambie 2 pilas de 9V'),
(2, 34, 1, 1, '2013-02-18', 1, NULL),
(3, 26, 1, 1, '2014-01-06', 1, NULL),
(4, 34, 1, 1, '2014-01-14', 0, NULL),
...
(119, 165, 1, 1, '2018-10-03', 1, NULL),
(120, 167, 1, 1, '2018-10-03', 1, NULL),
(126, 16, 1, 1, '2019-01-13', NULL, NULL),
(127, 105, 1, 1, '2019-01-01', NULL, 'hola'),
(128, 17, 1, 1, '2019-01-03', NULL, 'porqwe'),
(129, 16, 1, 1, '2019-01-06', 1, 'qewe'),
(130, 16, 1, 1, '2019-01-03', NULL, 'hg'),
(131, 16, 1, 1, '2019-01-03', NULL, 'jn'),
(132, 16, 1, 1, '2019-01-03', 0, NULL),
(134, 3, 1, 1, '2019-02-28', 0, 'esta va por ti <3'),
(135, 16, 1, 1, '2019-01-10', 0, NULL),
(136, 16, 1, 1, '2019-01-10', 1, NULL),
(137, 16, 1, 1, '2019-01-14', 0, NULL),
(138, 16, 1, 1, '2019-01-01', 0, NULL),
(139, 16, 1, 1, '2019-01-01', 0, NULL),
(140, 16, 1, 1, '2019-01-01', 0, NULL),
(141, 16, 1, 1, '2019-01-23', 1, NULL),
(142, 16, 1, 1, '2019-01-10', NULL, NULL),
(143, 16, 1, 1, '2019-01-30', 0, NULL),
(144, 16, 1, 1, '2019-01-01', 1, NULL),
(145, 16, 1, 1, '2019-01-01', NULL, NULL),
(146, 16, 1, 1, '2019-01-01', 0, NULL),
(147, 16, 1, 1, '2019-01-01', 1, NULL),
(148, 16, 1, 1, '2019-01-31', 0, NULL),
(149, 16, 1, 1, '2019-01-01', 0, 'es la prueba');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `maintenance_prev`
--

CREATE TABLE `maintenance_prev` (
  `id_prev` int(11) NOT NULL,
  `id_machine` int(11) NOT NULL,
  `id_interv` int(11) NOT NULL,
  `date` date NOT NULL,
  `prox_date` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Volcado de datos para la tabla `maintenance_prev`
--

INSERT INTO `maintenance_prev` (`id_prev`, `id_machine`, `id_interv`, `date`, `prox_date`) VALUES
(3, 16, 1, '2019-01-15', '2019-01-15'),
(4, 17, 1, '2019-01-15', '2019-01-15'),
(5, 16, 1, '2019-01-15', '2019-01-15'),
(6, 17, 1, '2019-01-15', '2019-02-14'),
(7, 95, 1, '2019-01-15', '2019-07-15'),
(9, 28, 1, '2019-01-15', '2019-07-15'),
(10, 148, 1, '2019-01-15', '2019-02-14'),
(11, 16, 1, '2019-01-15', '2020-01-15'),
(12, 10, 1, '2019-01-08', '2019-01-31'),
(13, 63, 1, '2019-01-01', '2020-02-27');
...
--
-- Estructura de tabla para la tabla `panne_p`
--

CREATE TABLE `panne_p` (
  `id_panne` int(11) NOT NULL,
  `id_machine` int(11) NOT NULL,
  `id_interv` int(11) NOT NULL,
  `date` date NOT NULL,
...
--
-- Volcado de datos para la tabla `panne_p`
--

INSERT INTO `panne_p` (`id_panne`, `id_machine`, `id_interv`, `date`, `organe`, `operation`, `nature_panne`, `cause_panne`, `garantie`, `temps_darret`, `PR`, `tps_interv`, `compteur`, `commentaire`) VALUES
(1, 10, 1, '2012-10-24', NULL, 'revision completa de la comunicación', 'no funciona', 'seguramente los conectores de las diademas estaban mal enchufados', 0, 5, '0', 0, 0, NULL),
(2, 7, 1, '2012-10-31', 'pantalla 5to radio enuncia Problema DSP6900 pero se le quito solo...', 'reemplace pila, apague y volvi a prenderlo....y funcionó....', 'ya funciona el 5to radio, pero reemplace una diadema por una nueva PHO020', 'perdida de sensibilidad del micro de una diadema', 1, 7, '1Diadema PHO020', 2, 0, NULL),
(3, 34, 1, '2012-10-31', 'Pager', 'reemplazo pila por nueva', 'no chifla el pager', 'pila del pager baja', 1, 7, '1 pila 9V', 1, 0, 'Limpieza y secado del pager pues estaba humedo.'),
(4, 17, 1, '2012-10-31', '2 diademas fallando', 'reemplazo de 2 diademas por PHO020', '2 diademas fallando', 'perdida de sensibilidad de los microfonos', 1, 7, '2 Diademas PHO020', 1, 0, 'Le di al Profesor Carlos Gonzalez irribare 2 diademas nuevas PHO020'),
...
(349, 95, 1, '2018-10-03', NULL, 'cambio de pila por nueva', '1 transceiver ya no retiene carga', '5 años', 0, 0, '0', 0, 1, NULL),
(350, 90, 1, '2018-10-03', NULL, 'cambio de 1 pila de radio', '1 pila de transceiver FS', 'equipo de 2013', 0, 0, '1', 0, 1, NULL),
(351, 16, 1, '2019-01-03', NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL),
(352, 16, 1, '2019-01-31', NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL),
(353, 16, 1, '2019-01-02', 'asd', NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL),
(354, 16, 1, '2019-01-03', NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL),
(355, 16, 1, '2019-01-31', 'qwe', 'qwe', 'qwe', 'qwe', 0, NULL, NULL, NULL, NULL, NULL),
(356, 16, 1, '2019-01-01', 'QWE', 'QWE', 'QWE', 'QWE', 1, NULL, NULL, NULL, NULL, NULL),
(357, 16, 1, '2019-01-01', NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL),
(358, 16, 1, '2019-01-31', NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL),
(359, 3, 1, '2019-01-01', 'qwe', 'qwe', 'qwe', 'qwe', 0, 0, '0', 0, 0, 'qwe'),
(360, 3, 1, '2019-01-30', 'qwe', 'qwe', 'qwe', 'qwe', 0, 0, '0', 0, 0, 'qwe'),
(361, 16, 1, '2019-01-30', 'qwe', 'qwe', 'qwe', 'qwe', 0, 0, '0', 0, 0, 'qwe'),
(362, 16, 1, '2019-01-14', 'qwe', 'qwe', 'qwe', 'qwe', 0, 0, '0', 0, 0, 'qwe'),
(363, 17, 1, '2019-01-31', 'qwe', 'qwe', 'qwe', 'qwe', 0, 0, '0', 0, 0, 'qwe'),
(364, 16, 1, '2019-01-01', 'asdasd', 'asdasd', 'asdasd', 'asdasd', 1, 0, '0', 0, 0, 'qwe'),
(365, 16, 1, '2019-01-01', 'asd', 'asd', 'asd', 'asd', 0, 0, '0', 0, 0, 'qwe'),
(366, 16, 1, '2019-01-14', 'asd', 'asda', 'asd', 'ad', 1, 0, '0', 0, 0, 'qwe'),
(367, 16, 1, '2019-01-16', 'l', 'l', 'l', 'l', 1, 1, '0', 0, 0, 'qwe'),
(368, 17, 1, '2019-01-10', 'l', 'l', 'l', 'l', 1, 9, '9', 0, 0, 'qwe'),
(369, 17, 1, '2019-01-18', 'l', 'l', 'l', 'l', 1, 9, '9', 9, 0, 'qwe'),
(370, 16, 1, '2019-01-16', 'p', 'p', 'p', 'p', 1, 9, '9', 9, 9, ''),
(371, 16, 1, '2019-01-16', 'o', 'o', 'o', 'o', 1, 9, '9', 9, 9, 'o'),
(372, 16, 1, '2019-01-31', 'k', 'k', 'k', 'k', 1, 5, '5', 5, 5, 'karen el tocino'),
(373, 16, 1, '2019-01-02', NULL, NULL, NULL, NULL, 0, 0, NULL, 0, 0, NULL);
...
--
-- Indices de la tabla `machine_p`
--
ALTER TABLE `machine_p`
  ADD PRIMARY KEY (`id_machine`),
  ADD KEY `id_client` (`id_client`);
...
--
-- Indices de la tabla `maintenance_p`
--
ALTER TABLE `maintenance_p`
  ADD PRIMARY KEY (`id_maint`),
  ADD KEY `id_machine` (`id_machine`),
  ADD KEY `id_oper` (`id_oper`),
  ADD KEY `id_interv` (`id_interv`);
...
--
-- Indices de la tabla `maintenance_prev`
--
ALTER TABLE `maintenance_prev`
...
--
-- AUTO_INCREMENT de la tabla `machine_p`
--
ALTER TABLE `machine_p`
  MODIFY `id_machine` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=233;
...
--
-- AUTO_INCREMENT de la tabla `maintenance_p`
--
ALTER TABLE `maintenance_p`
  MODIFY `id_maint` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=150;

--
-- AUTO_INCREMENT de la tabla `maintenance_prev`
--
ALTER TABLE `maintenance_prev`
  MODIFY `id_prev` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
-- AUTO_INCREMENT de la tabla `panne_p`
--
ALTER TABLE `panne_p`
  MODIFY `id_panne` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=374;
...
--
-- Filtros para la tabla `maintenance_prev`
--
ALTER TABLE `maintenance_prev`
  ADD CONSTRAINT `maintenance_prev_ibfk_1` FOREIGN KEY (`id_machine`) REFERENCES `machine` (`id_machine`),
  ADD CONSTRAINT `maintenance_prev_ibfk_2` FOREIGN KEY (`id_interv`) REFERENCES `intervenants` (`id_interv`);
